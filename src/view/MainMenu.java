...
public class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		Font tabFont = new Font("나눔스퀘어 Bold", Font.BOLD, 24);
		...
		selectOnewayBtn.setFont(new Font("나눔스퀘어 Bold", Font.PLAIN, 20));
		...
		selectRoundtripBtn.setFont(new Font("나눔스퀘어 Bold", Font.PLAIN, 20));
		...
		ticketingTabbedPane.setTabComponentAt(1, ticketConfirmLabel);
	...
	private void initReservationPanel(JPanel target, String type) {
		...
		depPlaceLabel.setFont(new Font("나눔스퀘어", Font.PLAIN, 20));
		...
		arrPlaceLabel.setFont(new Font("나눔스퀘어", Font.PLAIN, 20));
		...
		headCountPanel.setFont(new Font("나눔스퀘어", Font.PLAIN, 20));
		...
		selectChildLabel.setFont(new Font("나눔스퀘어", Font.PLAIN, 20));
		...
		selectAdultLabel.setFont(new Font("나눔스퀘어", Font.PLAIN, 20));
		...
		selectSeniorLabel.setFont(new Font("나눔스퀘어", Font.PLAIN, 20));
