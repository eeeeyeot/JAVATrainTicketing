...
public class StartMenu extends JFrame {
	...
	public StartMenu() {
		...
		signPanel.setLayout(new BorderLayout(0, 0));
		
		JPanel gridPanel = new JPanel();
		gridPanel.setBorder(null);
		signPanel.add(gridPanel, BorderLayout.NORTH);
		...
		idTextField_in.setText("ghfuf12");
		...
		signPanel.add(signUpButton, BorderLayout.SOUTH);
